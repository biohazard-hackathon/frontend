                            ...
                            <div className="d-flex flex-row align-items-center">
                                <div className="d-flex flex-column mr-2">
                                    <div className="profile-image">
										<img className="rounded-circle" src="https://i.imgur.com/xbxOs06.jpg" width="30"/>
											<img className="rounded-circle" src="https://i.imgur.com/KIJewDa.jpg" width="30"/>
										<img className="rounded-circle" src="https://i.imgur.com/wwd9uNI.jpg" width="30"/>
										</div><span className="date-time">11/4/2020 12:55</span></div>
                                <i
                        ...
                        <li className="d-flex justify-content-between">
                            ...
                            <div className="d-flex flex-row align-items-center">
                                <div className="d-flex flex-column mr-2">
									...
									<span className="date-time">12/5/2020 12:55</span></div><i className="fa fa-ellipsis-h"></i></div>
                        </li>
                        <li className="d-flex justify-content-between">
                            <div className="d-flex flex-row align-items-center"><i className="fa fa-check-circle checkicon"></i>
                                <div className="ml-2">
                            ...
                            <div className="d-flex flex-row align-items-center">
                                <div className="d-flex flex-column mr-2">
                                    <div className="profile-image">
										<img className="rounded-circle" src="https://i.imgur.com/xbxOs06.jpg" width="30" />
										<img className="rounded-circle" src="https://i.imgur.com/KIJewDa.jpg" width="30" />
										</div><span className="date-time">16/4/2020 1:55</span></div><i className="fa fa-ellipsis-h"></i></div>
                        </li>
                        <li className="d-flex justify-content-between">
                            <div className="d-flex flex-row align-items-center"><i className="fa fa-check-circle checkicon"></i>
                                <div className="ml-2">
                            ...
                            <div className="d-flex flex-row align-items-center">
                                <div className="d-flex flex-column mr-2">
									...
									<span className="date-time">11/4/2020 12:55</span></div><i className="fa fa-ellipsis-h"></i></div>
                        </li>
                    </ul>
                </div>
            </div>
